...
void configInitCamera(){
  ...
  if(psramFound()){
    ...
    config.jpeg_quality = 10;  //0-63 lower number means higher quality. Default setup: 10
    config.fb_count = 2;
  } else {
    config.frame_size = FRAMESIZE_SVGA;
    config.jpeg_quality = 12;  //0-63 lower number means higher quality. Default setup: 12
    config.fb_count = 1;
  }
